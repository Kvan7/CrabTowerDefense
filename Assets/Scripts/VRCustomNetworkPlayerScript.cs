...
public class VRCustomNetworkPlayerScript : NetworkBehaviour
{
    ...
    public readonly static List<VRCustomNetworkPlayerScript> playersList = new List<VRCustomNetworkPlayerScript>();
    ...
    void OnRightObjectChangedHook(NetworkIdentity _old, NetworkIdentity _new)
    {
        if (rightHandObject)
        {
            ...
            towerRight = rightHandObject.GetComponent<AbstractTower>();
    ...
    void OnLeftObjectChangedHook(NetworkIdentity _old, NetworkIdentity _new)
    {
        if (leftHandObject)
        {
            ...
            towerLeft = leftHandObject.GetComponent<AbstractTower>();
